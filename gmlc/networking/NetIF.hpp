 ...
 */
inline std::vector<std::string> getInterfaceAddressesV4 () { return getInterfaceAddresses (AF_INET); }
 ...
 */
inline std::vector<std::string> getInterfaceAddressesV6 () { return getInterfaceAddresses (AF_INET6); }
 ...
 */
inline std::vector<std::string> getInterfaceAddressesAll () { return getInterfaceAddresses (AF_UNSPEC); }
}  // namespace networking
}  // namespace gmlc
